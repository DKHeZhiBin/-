 ...
 * 
 * @see entity.AdminTable
 * @author MyEclipse Persistence Tools
 */

public class AdminTableDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(AdminTableDAO.class);
	// property constants
	...
	public List findByExample(AdminTable instance) {
		...
		try {
			List results = getSession().createCriteria("entity.AdminTable")
